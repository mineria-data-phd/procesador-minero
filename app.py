...
# 1. TRADUCTOR INFALIBLE (Recuperado de la versión exitosa)
...
def extraer_datos_mineros(texto_sucio):
    ...
    # Buscamos específicamente la fecha que viene después de la ciudad al FINAL del texto.
    # Usamos una búsqueda que solo capture palabras de fecha, no párrafos largos.
...
# --- INTERFAZ ---
st.title("⚒️ Sistema Minero: Corrección de Datos")
archivo_pdf = st.file_uploader("Sube el PDF de VALENTINA 2", type=["pdf"])
...
if archivo_pdf:
    ...
    if datos:
        ...
        # Mostramos la tabla para verificar antes de descargar
